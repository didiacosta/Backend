...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tracks_track', 'album',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['albums.Album'], default=2),
                      keep_default=False)
    ...
    models = {
        'albums.album': {
            ...
            'artis': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['artists.Artist']"}),
        ...
        'artists.artist': {
            ...
            'fris_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
